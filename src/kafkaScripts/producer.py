...
Outputs (into --out-dir):
  ...
  customer_personas.csv    -- the HIDDEN ground-truth persona used to drive the simulation (purchase_intent, indecisiveness, engagement_level). 

Usage:
  python producer.py --n-users 2000 --n-products 300 --n-days 30
...
# ---------------------------------------------------------------------------
# Static reference tables (customers / products) 
# ---------------------------------------------------------------------------
