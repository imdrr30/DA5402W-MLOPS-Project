...
python ./src/pythonScripts/topicCreator.py

#Step:3
python ./src/pythonScripts/launch_producer.py --n-users 1000 --n-products 200 --batch-size 500 --interval-seconds 5 --kafka-broker kafka:9094 --out-dir ./output/kafkaOutput --seed 42 --run-forever
